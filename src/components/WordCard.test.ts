...
describe('WordCard 翻面状态', () => {
  it('revealed=false: flipper 无 .flipped 类', () => {
    const wrapper = mount(WordCard, { props: { word: w, revealed: false } });
  ...
  it('revealed=true: flipper 拿到 .flipped 类', () => {
    const wrapper = mount(WordCard, { props: { word: w, revealed: true } });
...
describe('WordCard 评分反馈', () => {
  it('feedback=null 不带任何 fb-* 类', () => {
    const wrapper = mount(WordCard, { props: { word: w, revealed: true, feedback: null } });
  ...
  it('feedback="wrong" 加 fb-wrong 类', () => {
    const wrapper = mount(WordCard, { props: { word: w, revealed: true, feedback: 'wrong' } });
    expect(wrapper.find('.card-scene').classes()).toContain('fb-wrong');
  });

  it('feedback="right" 加 fb-right 类', () => {
    const wrapper = mount(WordCard, { props: { word: w, revealed: true, feedback: 'right' } });
    expect(wrapper.find('.card-scene').classes()).toContain('fb-right');
  });

  it('feedback="soft" 加 fb-soft 类', () => {
    const wrapper = mount(WordCard, { props: { word: w, revealed: true, feedback: 'soft' } });
